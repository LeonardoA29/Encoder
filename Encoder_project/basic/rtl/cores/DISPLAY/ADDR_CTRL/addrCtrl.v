...
parameter total_frame_bits = 250 * 122 * 2;
...
localparam end_address = CONFIG_END_ADDR + end_bits/cell_size + 1;
localparam end_address_with_ending_cmds = end_address + 4;
//
...
assign configState = (pointerResets == 0 && address < CONFIG_END_ADDR )|| address > end_address? 1:0;
